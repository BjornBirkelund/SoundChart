...
class App extends Component {
  ...
  handleUpdateData = chart => {
    let myData = [...this.state.soundlevels.DayChart];
    ...
    // });
    // chart.update();
    // chart.datasets[0] = myData;
    // chart.update();
    console.log("g data", myData, chart);
  };
      ...
      <ButtonToolbar>
        ...
        >
          <ToggleButton
            ...
            onClick={e => {
              this.setState({ selectedChartType: "DayChart" });
            }}
          >
            Day
          </ToggleButton>
          <ToggleButton
            ...
            variant="outline-light"
            onClick={e => {
              this.setState({ selectedChartType: "WeekChart" });
            }}
          >
            Week
          </ToggleButton>
          <ToggleButton
            ...
            variant="outline-light"
            onClick={e => {
              this.setState({ selectedChartType: "MonthChart" });
            }}
          >
            Month
          </ToggleButton>
          <ToggleButton
            ...
            variant="outline-light"
            onClick={e => {
              this.setState({ selectedChartType: "YearChart" });
            }}
          >
            Year
          </ToggleButton>
  ...
  renderSelectedChart(selectedChartType) {
    ...
    return <Chart data={data} onDataUpdate={this.handleUpdateData} />;
  }
}
